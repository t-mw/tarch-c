...
#    if !SX_CRT_BIONIC && !SX_CRT_GLIBC && !SX_CRT_LIBCXX && !SX_CRT_MINGW && !SX_CRT_MSVC && \
        !SX_CRT_MUSL && !SX_CRT_NEWLIB
#        undef SX_CRT_NONE
...
#if SX_COMPILER_GCC
#    define SX_COMPILER_NAME                                                             \
        "GCC " sx_stringize(__GNUC__) "." sx_stringize(__GNUC_MINOR__) "." sx_stringize( \
            __GNUC_PATCHLEVEL__)
...
#    define SX_PLATFORM_NAME "Android " sx_stringize(SX_PLATFORM_ANDROID)
#elif SX_PLATFORM_BSD
#    define SX_PLATFORM_NAME "BSD"
#elif SX_PLATFORM_EMSCRIPTEN
#    define SX_PLATFORM_NAME                                           \
        "asm.js " sx_stringize(__EMSCRIPTEN_major__) "." sx_stringize( \
            __EMSCRIPTEN_minor__) "." sx_stringize(__EMSCRIPTEN_tiny__)
